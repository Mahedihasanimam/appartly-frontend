...
const {data,isLoading}=useLogdinuserReservationQuery()
  ...
  const upcommingReservations = data?.rooms?.filter((reservation) => reservation.checkinCheckoutStatus === 'checkin' );
  // Dummy data
...
console.log(data)
  ...
  return (
    <div className="container mx-auto">
      ...
      />
        <Button style={{backgroundColor: "#EBCA7E", fontWeight: "bold",color:"black"}}>checkin ({upcommingReservations?.length}) </Button>
