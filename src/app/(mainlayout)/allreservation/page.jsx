...
//   // State for pagination and active tab
...
//           <div>
//             <span className="text-[16px] font-normal">{text}</span>
...
//           borderBottom: '2px solid #EBCA7E', // Add a border
//         }}
//       >
//         <Tabs.TabPane
...
//             Previous
//           </Button>
//           <Button onClick={() => setCurrentPage((prev) => Math.min(prev + 1, Math.ceil(filteredData.length / pageSize)))} disabled={currentPage === Math.ceil(filteredData.length / pageSize)}>
//             Next
//           </Button>
//         </div>
//       </div>
