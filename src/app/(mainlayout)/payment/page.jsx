      ...
      <div className="w-full max-w-6xl  space-y-6 ">
          ...
          <div className="flex-1">
            ...
            <div className="mb-4 mt-[64px]">
              ...
              <div className="space-y-4">
                ...
                <Input size="large" placeholder="City" className="bg-[#242424] hover:bg-[#242424]  border-none text-[#FFFFFFCC] opacity-70 text-[16px]" />
                <Input size="large" placeholder="Contact number" className="bg-[#242424] hover:bg-[#242424]  border-none text-[#FFFFFFCC] opacity-70 text-[16px]" />
                <div className="flex gap-2">
                  <Input size="large" placeholder="State" className="bg-[#242424] hover:bg-[#242424]  border-none text-[#FFFFFFCC] opacity-70 text-[16px]" />
        ...
        <Button style={{backgroundColor: '#EBCA7E',color: 'black'}} type="primary" size="large" className="bg-yellow-500 text-black font-bold w-fit mx-auto px-8 mt-12 block">
          ...
          <div className="w-80 p-4 py-8 lg:mt-0 md:mt-0 mt-12 lg:w-auto md:w-auto  bg-[#1B1B1B] h-fit rounded-lg space-y-4">
            ...
            <Select
      defaultValue="2"
      className="custom-select w-full h-[44px] "
    >
      ...
      <Select.Option value="2">2 Guests</Select.Option>
            ...
            <div className="space-y-3 pt-8 text-[#FFFFFFCC]">
              <div className="flex justify-between">
                <span>$80*5nights</span> <span>$400</span>
              </div>
              <div className="flex justify-between">
