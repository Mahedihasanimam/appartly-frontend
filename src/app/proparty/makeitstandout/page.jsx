    ...
    for (const file of files) {
      ...
      try {
        ...
        while (true) {
          ...
          setProgress((totalUploaded / totalFiles) * 100 + (percent / totalFiles));
        }
